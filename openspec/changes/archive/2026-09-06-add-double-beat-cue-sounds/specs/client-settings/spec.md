...
#### Scenario: Choose double-beat cue sound
- **WHEN** the user selects any double-beat cue sound option
- **THEN** the recording feedback SHALL play two short tones per cue instead of one
- **AND** the selected option SHALL persist like the other built-in cue sound kinds
