...
## Purpose
TBD - created by archiving change update-readme-and-add-homepage. Update Purpose after archive.
## Requirements
...
### Requirement: README 具备站点与文档路由
README SHALL 包含可执行的本地使用或开发起步说明，并 SHALL 链接到公开站点或更深入的项目文档，例如环境搭建、HTTP API 用法、Telegram Bridge 说明、发布/更新信息及其他后续阅读主题。

#### Scenario: 访客希望在总览后继续深入
- **WHEN** 访客阅读完 README 的总览部分
- **THEN** 访客可以沿着清晰的快速开始路径继续操作
- **AND** 访客无需手动搜索仓库目录即可进入公开站点或相关深度文档
